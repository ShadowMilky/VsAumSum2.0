...
class CharMenu extends MusicBeatState{
    ...
    function charCheck()
    {
        ...
        if (unlockedCharacters[curSelected] == 'bf-car' || unlockedCharacters[curSelected] == 'bf' || unlockedCharacters[curSelected] == 'bf-christmas' || unlockedCharacters[curSelected] == 'bf-holding-gf')
            icon.changeIcon('bf');
